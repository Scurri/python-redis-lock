...
class RedisCache(PlainRedisCache):
    ...
    def lock(self, key, expire=None, id=None, auto_renewal=False, blocking=False):
        return Lock(self.__client, key, expire=expire, id=id, auto_renewal=auto_renewal, blocking=blocking)
